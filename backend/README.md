...
## Project Structure
    ...
    ├── testapiautoconnect_112895  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112895`
...
2. Clone this repo and `cd testapiautoconnect_112895`
